...
public class DCSDocAppActivity extends Activity {
	...
	public class AsynCallToWebService extends AsyncTask<Void, Void, String> {
		...
		protected void onPreExecute() {
			...
			dialog = ProgressDialog.show((Context) DCSDocAppActivity.this, "",
		...
		protected void onPostExecute(String result) {
			...
			/*if (result.equals("PASS")) {
				...
				Toast.makeText(DCSDocAppActivity.this,
						"User Not Found!!! Please check your credentials!",
						Toast.LENGTH_LONG).show();

			}*/
			startActivity(new Intent(DCSDocAppActivity.this,MainActivity.class));
		}
